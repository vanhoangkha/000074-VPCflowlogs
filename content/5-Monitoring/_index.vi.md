...
Sau khi đã triển khai hạ tầng mạng và kích hoạt VPC Flow Logs, chúng ta sẽ bắt đầu giám sát hạ tầng.
...
3. Truy cập vào trong log stream để xem chi tiết Log events.
